...
const Hero = () => {
  ...
  return (
    ...
    <h1 className='font-playfair text-2xl md:text-5xl md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-5'>Discover Your Perfect Gateway Destination</h1>
    ...
    <form onSubmit={onSearch}className='bg-white text-gray-500 rounded-lg px-6 py-4 flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto mt-8'>
            ...
            <div>
                ...
                <input onChange={e=> setDestination(e.target.value)} list='destinations' id="destinationInput" type="text" className=" rounded border border-gray-200 px-3 py-1.5
                 mt-1.5 text-sm outline-none" placeholder="Type here" required />
            ...
            <button className='flex items-center justify-center gap-1 rounded-full bg-black py-3 px-6 text-white font-semibold my-auto cursor-pointer max-md:w-full max-md:py-2' >
