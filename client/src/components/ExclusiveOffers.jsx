    ...
    pt-20 pb-30'>
        <div className='flex flex-col md:flex-row items-center justify-between w-full'>
         ...
         <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-20'>
          ...
          <div key={item._id} className='group relative flex flex-col items-start justify-between gap-1 pt-12 md:pt-18 px-4 rounded-xl
           text-white bg-no-repeat bg-cover bg-center' style={{backgroundImage: `url(${item.image})`}}>
