  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 px-4 md:px-16 lg:px-24 xl:px-32'>
      <div className='flex flex-col items-start'>
            ...
            <div className='md:w-1/2 flex flex-col gap-2'>
             ...
             {/* Room Amenities */}
              ...
              <div key={index} className='flex items-center gap-2 px-3 py-2 rounded-lg bg-[#F5F5FF]/70'>
               ...
               <p className='text-xl font-medium text-gray-700'>${room.pricePerNight} /night
               </p>
            </div>
          </div>
        ))}
       ...
       {/* Filters */}
      <div className='bg-white w-80 border border-gray-300 text-gray-600 mt-6 max-lg:mb-8 lg:mt-16'>
